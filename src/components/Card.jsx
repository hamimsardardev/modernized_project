        ...
        <div className="mt-20">
          <Slider ref={sliderRef} {...settings}>
            ...
            <div className="group ml-3 bg-[#FFB000] border border-gray-300 rounded-[14px] shadow-xl/20 pt-[38px] pb-[35px] pr-[29px] pl-[25px] hover:bg-[#FFFFFF]">
              ...
              <p className="w-auto font-medium text-[18px] text-[#FFFFFF] leading-[168%] pb-5 group-hover:text-[#012645]">
                Looking to establish or improve your business’s online presence?
                Let us craft a website that compliments and propagates your
                business – designing a website that fits your niche and your
                tone while standing out from your competitors Lorem ipsum dolor
                sit amet consectetur adipisicing elit. Voluptas, maxime..
              </p>
              <button
