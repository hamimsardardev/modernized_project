    ...
    <>
      <section className="bg-[#F9F1E5] pt-20 px-4 sm:px-6 lg:px-8">
        <div className="container">
          ...
          <table className="w-full border-collapse text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px]">
            <thead>
              <tr className="bg-[#D94F00] font-regular text-[14px] sm:text-[15px] lg:text-[18px] text-white text-left">
                <th className="p-2 sm:p-3 lg:pl-8 text-start font-semibold lg:font-bold">
                  PACKAGES BY LEVEL SERVICES
                </th>
                <th className="p-2 sm:p-3 font-semibold lg:font-bold text-center">
                  BASIC WEBSITE
                </th>
                <th className="p-2 sm:p-3 font-semibold lg:font-bold text-center">
                  BUSINESS WEBSITE
              ...
              <tr className="bg-[#FFB000] font-semibold text-[16px] sm:text-[18px] lg:text-[24px] text-white text-center">
                <th colSpan={4} className="p-2 lg:font-bold">
                  <a href="">Research</a>
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr className="bg-[#FFFFFF] font-medium text-[14px] sm:text-[16px] lg:text-[18px] text-[#585858]">
                <td className="p-2 sm:p-3 lg:pl-8 text-start">Post Updates</td>
                <td className="p-2 sm:p-3 text-center">3 per week/network</td>
                <td className="p-2 sm:p-3 text-center">5 per week/network</td>
                <td className="p-2 sm:p-3 text-center">1 per day/network</td>
              </tr>
              <tr className="bg-[#EFEFEF] font-medium text-[14px] sm:text-[16px] lg:text-[18px] text-[#585858]">
                <td className="p-2 sm:p-3 lg:pl-8 text-start">
