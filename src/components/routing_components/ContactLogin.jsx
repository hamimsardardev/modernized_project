    ...
    <div>
      <section className="my-12 lg:my-[70px] ">
        <div className="container">
          ...
          <div
            className="bg-[#F9EFE2] lg:mt-[54px] lg:flex lg:flex-row lg:gap-[94px] lg:pt-[74px] lg:pr-[74px] md:flex md:flex-col md:gap-[40px] lg:pl-[44px] lg:pb-[83px] py-[20px] px-[20px]"
          >
            <div>
